...
void Mayo::PropertyGroupSignals::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        PropertyGroupSignals *_t = static_cast<PropertyGroupSignals *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Mayo::PropertyGroupSignals::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Mayo__PropertyGroupSignals.data,
      qt_meta_data_Mayo__PropertyGroupSignals,  qt_static_metacall, nullptr, nullptr}
};
