...
QT_MOC_LITERAL(1, 36, 7), // "cleared"
QT_MOC_LITERAL(2, 44, 0), // ""
QT_MOC_LITERAL(3, 45, 7), // "changed"
QT_MOC_LITERAL(4, 53, 21), // "Span<ApplicationItem>"
QT_MOC_LITERAL(5, 75, 8), // "selected"
QT_MOC_LITERAL(6, 84, 10) // "deselected"

    },
    "Mayo::ApplicationItemSelectionModel\0"
    "cleared\0\0changed\0Span<ApplicationItem>\0"
...
void Mayo::ApplicationItemSelectionModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ApplicationItemSelectionModel *_t = static_cast<ApplicationItemSelectionModel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->cleared(); break;
        case 1: _t->changed((*reinterpret_cast< Span<ApplicationItem>(*)>(_a[1])),(*reinterpret_cast< Span<ApplicationItem>(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ApplicationItemSelectionModel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ApplicationItemSelectionModel::cleared)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ApplicationItemSelectionModel::*)(Span<ApplicationItem> , Span<ApplicationItem> );
...
QT_INIT_METAOBJECT const QMetaObject Mayo::ApplicationItemSelectionModel::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Mayo__ApplicationItemSelectionModel.data,
      qt_meta_data_Mayo__ApplicationItemSelectionModel,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void Mayo::ApplicationItemSelectionModel::cleared()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Mayo::ApplicationItemSelectionModel::changed(Span<ApplicationItem> _t1, Span<ApplicationItem> _t2)
{
