...
QT_MOC_LITERAL(3, 39, 12), // "GuiDocument*"
QT_MOC_LITERAL(4, 52, 6), // "guiDoc"
QT_MOC_LITERAL(5, 59, 17), // "guiDocumentErased"
QT_MOC_LITERAL(6, 77, 18) // "const GuiDocument*"

    },
    "Mayo::GuiApplication\0guiDocumentAdded\0"
    "\0GuiDocument*\0guiDoc\0guiDocumentErased\0"
    "const GuiDocument*"
};
...
void Mayo::GuiApplication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->guiDocumentAdded((*reinterpret_cast< GuiDocument*(*)>(_a[1]))); break;
        case 1: _t->guiDocumentErased((*reinterpret_cast< const GuiDocument*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        case 0:
            ...
            default: *reinterpret_cast<int*>(_a[0]) = -1; break;
            case 0:
                *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< GuiDocument* >(); break;
            }
            break;
        }
        ...
        {
            using _t = void (GuiApplication::*)(GuiDocument * );
        ...
        {
            using _t = void (GuiApplication::*)(const GuiDocument * );
...
QT_INIT_METAOBJECT const QMetaObject Mayo::GuiApplication::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Mayo__GuiApplication.data,
      qt_meta_data_Mayo__GuiApplication,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void Mayo::GuiApplication::guiDocumentAdded(GuiDocument * _t1)
{
...
// SIGNAL 1
void Mayo::GuiApplication::guiDocumentErased(const GuiDocument * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
