...
public:
    ...
    void setupUi(QDialog *Mayo__DialogAbout)
    {
        if (Mayo__DialogAbout->objectName().isEmpty())
            Mayo__DialogAbout->setObjectName(QStringLiteral("Mayo__DialogAbout"));
        ...
        label_AppByOrg->setObjectName(QStringLiteral("label_AppByOrg"));
        QFont font;
        font.setBold(true);
        font.setWeight(75);
        ...
        label_BuildDateTime->setObjectName(QStringLiteral("label_BuildDateTime"));
        ...
        label_Qt->setObjectName(QStringLiteral("label_Qt"));
        ...
        label_Gmio->setObjectName(QStringLiteral("label_Gmio"));
