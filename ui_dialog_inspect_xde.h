...
public:
    ...
    void setupUi(QDialog *Mayo__DialogInspectXde)
    {
        if (Mayo__DialogInspectXde->objectName().isEmpty())
            Mayo__DialogInspectXde->setObjectName(QStringLiteral("Mayo__DialogInspectXde"));
        ...
        treeWidget_Document->setObjectName(QStringLiteral("treeWidget_Document"));
        ...
        treeWidget_LabelProps->setObjectName(QStringLiteral("treeWidget_LabelProps"));
